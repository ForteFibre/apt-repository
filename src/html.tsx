...
echo \\
  "deb [signed-by=/etc/apt/keyrings/fortefibre.asc] https://apt.fortefibre.net/repo/ jammy main" | \\
  sudo tee /etc/apt/sources.list.d/fortefibre.list > /dev/null

echo machine apt.fortefibre.net login ${username} password ${password} > /etc/apt/auth.conf.d/fortefibre
